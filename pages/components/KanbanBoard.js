...
export default function KanbanBoard(props) {
  return (
    <>
      <div className="list-container w-96 ml-2.5 sm:w-320 sm:ml-1.5">
        <div className="list-header">
          <div className="list-header-left flex px-0 py-4">
            {
              {
                status: (
                  <>
                    {
                      {
                        Backlog: (
                          <div className="list-icon mr-5 cursor-pointer text-gray-600">
                            <svg
                  ...
                  <>
                    {
                      {
                        0: (
                          <div className="list-icon mr-5 cursor-pointer text-gray-600 mr-5 cursor-pointer ">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="22"
                              height="22"
            ...
            <div className="px-5">Total Items: {cardCount}</div>
            <div className="list-header-right flex items-center px-8">
              <div className="list-add-item mr-1 cursor-pointer ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  height="18"
              ...
              <div className="list-option-item cursor-pointer ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  height="18"
